...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamUsers = channel.unary_stream(
                ...
                request_serializer=service__pb2.UserListRequest.SerializeToString,
...
class UserServiceServicer(object):
    ...
    def GetUser(self, request, context):
        """Unary RPC - Gọi 1-1 lấy thông tin User
        """
    ...
    def StreamUsers(self, request, context):
        """Server Streaming RPC - Trả về luồng dữ liệu (danh sách user)
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StreamUsers': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=service__pb2.UserListRequest.FromString,
...
class UserService(object):
    ...
    def StreamUsers(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/users.UserService/StreamUsers',
            service__pb2.UserListRequest.SerializeToString,
